...
Designing web pages to be usable for people with varying abilities. (colorblind, blind etc)
2. Talk about 3 different things you can do to ensure your website is accessible. 
Use descriptive HTML for page readers, use good color schemes for colorblind people, no flashing/strobe effects for people with epilepsy.
3. How would you explain the concept of a variable to someone new to programming?
its basically an item we use to store specific information.

4. What is the purpose of using functions in code?
to make things simpler and keep from repeating yourself. 
