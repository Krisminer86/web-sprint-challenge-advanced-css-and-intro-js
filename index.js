...
/* Task 4: Create a function called get20s() that takes data as an argument and returns an array with
 names of artists who were born in and died in 20th century (1900-2000) example born in 1901 and died 
 ...
 function get20s(array){
  ...
  for (i=0; i< artists.lenght; i++){
    artist = artists[i]
    let date = artists.years;
    if (artist.years > 1900 && artist.years < 2000){
      centuries.push(artist)
    }
  return centuries
  }
